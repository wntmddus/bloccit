...
RSpec.describe SponsoredPostsController, type: :controller do
  let(:my_sponsored_post) { SponsoredPost.create!(name: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price) }
   ...
   describe "POST create" do
     it "increases the number of sponsored_posts by 1" do
       expect{ post :create, {sponsored_post: {name: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price}}}.to change(SponsoredPost,:count).by(1)
     end

     it "assigns SponsoredPost.last to @sponsored_post" do
       post :create, {sponsored_post: {name: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price}}
   ...
   describe "PUT update" do
     it "updates sponsored_post with expected attributes" do
       ...
       put :update, id: my_sponsored_post.id, sponsored_post: { name: new_name, body: new_body, price: new_price }
